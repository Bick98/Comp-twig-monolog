...
$logsPath = "/var/www/html/EHOR/log/messages.log";
...
if (isset($_GET['logs'])) {
    ...
    echo("Логи: ");
    $file = file_get_contents("/var/www/html/EHOR/log/messages.log");
    echo $file;
}
...
function add_mes_to_json($log2, $mes){
    ...
    $mes_json['messages'] [] = ['date' => date('d.m.y h:i:s'),'user'=>$log2, 'message' => $mes];
